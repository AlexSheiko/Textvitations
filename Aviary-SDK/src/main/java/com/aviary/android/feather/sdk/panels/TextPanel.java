...
public class TextPanel extends AbstractContentPanel
    implements OnDrawableEventListener, OnEditorActionListener, OnItemsScrollListener, OnKeyListener {
    ...
    private void beginEdit(final DrawableHighlightView view) {
        ...
        InputMethodManager manager =
            (InputMethodManager) getContext().getBaseContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (null != manager) {
    ...
    public void onFocusChange(final DrawableHighlightView newFocus, final DrawableHighlightView oldFocus) {
        ...
        if (newFocus != null) {
            if (newFocus.getContent() instanceof EditableDrawable) {
