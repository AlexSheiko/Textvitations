...
public abstract class AviaryAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public void setOnClickListener(OnClickListener l) {
        throw new RuntimeException(
            "Don't call setOnClickListener for an AviaryAdapterView. " + "You probably want setOnItemClickListener instead");
    }
    ...
    void checkSelectionChanged() {
        Log.i(VIEW_LOG_TAG,
              "checkSelectionChanged " + ((mSelectedPosition != mOldSelectedPosition) || (mSelectedRowId != mOldSelectedRowId)));
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (AviaryAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0
                && mItemCount > 0) {
