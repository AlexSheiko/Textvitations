...
public class CropPanel extends AbstractContentPanel
    implements com.aviary.android.feather.sdk.widget.AviaryGallery.OnItemsScrollListener, OnItemClickListener {
    ...
    protected void onGenerateResult() {
        RectD cropRect = new RectD(((CropImageView) mImageView).getHighlightView().getCropRectD());
        GenerateResultTask task = new GenerateResultTask(cropRect);
    ...
    class GenerateResultTask extends AviaryAsyncTask<Bitmap, Void, Bitmap> {
        ...
        protected void doPostExecute(Bitmap result) {
            ...
            ((CropImageView) mImageView).setImageBitmap(result,
                                                        ((CropImageView) mImageView).getAspectRatio(),
