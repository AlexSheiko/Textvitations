...
public class IAPDialogMain implements IAPDialogList.OnPackSelectedListener, AviaryStoreWrapper.Callback {
    ...
    public IAPDialogMain(ViewGroup view) {
        ...
        mStoreWrapper = new AviaryStoreWrapper(this, ((Object) this).getClass().hashCode());
    ...
    private static ViewGroup addToParent(ViewGroup parent, int index) {
        ViewGroup view =
            (ViewGroup) LayoutInflater.from(parent.getContext()).inflate(R.layout.aviary_iap_dialog_container, parent, false);
    ...
    public void update(IAPUpdater updater, boolean firstTime) {
        ...
        displayChild(mData, targetChild, firstTime);
    ...
    void displayChild(final IAPUpdater mData, int targetChild, boolean firstTime) {
        int currentChild = mViewAnimator.getDisplayedChild();
        logger.info("displayChild: %d, current: %d, firstTime: %b", targetChild, currentChild, firstTime);

        if (null != mData) {
            mData.isAnimating = firstTime || (targetChild != currentChild);
        }
        ...
        if (targetChild == 0) {
            mViewAnimator.setInAnimation(getContext(), R.anim.aviary_void_animation);
            ...
            mViewAnimator.setOutAnimation(getContext(), R.anim.aviary_void_animation);
        }
    ...
    public static class IAPUpdater implements Cloneable {
        ...
        public Object clone() {
            ...
            cloned.isAnimating = isAnimating;
            if (dialogExtras != null) {
                cloned.dialogExtras = (Bundle) dialogExtras.clone();
            }
            return cloned;
        }
        ...
        @Override
        public int hashCode() {
            return Long.valueOf(packId).hashCode() + 37 * packType.hashCode();
        }
